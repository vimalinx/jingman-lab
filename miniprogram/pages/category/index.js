...
Page(A.define(C.attach({ data: { categories: [], products: [], page: 1, pages: 1, total: 0, loading: false, q: '', cat: 0, error: '' }, async onShow() { if (!A.requireLogin())
